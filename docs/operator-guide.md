...
2. Register the client's intake: business type, the specific
   MEXT-regulated activity involved, prior filing/compliance
   history in Japan if any.
3. Run the advisor in read-only mode against Ministry of Education, Culture, Sports, Science and Technology's
   (文部科学省) published guidance.
...
5. Enable gated filing/compliance-draft assistance once the
   Research & Education Compliance Governor contract is trusted; actual submission always
   requires human sign-off.

## Minimum Production Controls

- client-owned data store for compliance documents
- clear provenance (official MEXT source citation) for every
...
automated actions cannot bypass the Research & Education Compliance Governor, and a working
